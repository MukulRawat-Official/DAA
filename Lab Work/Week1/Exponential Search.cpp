...
/*
                  EXPONENTIAL SEARCH :- T(N)  =  O(LOG N)
                  For first root N elements exponential search is much faster than binary search else binary seach is faster
*/
#include <iostream> 
using namespace std;
...
cin>>key;
int pos = exponential_Search(arr, n, key); if(pos == -1)
cout<<"Element not present"<<endl; else
